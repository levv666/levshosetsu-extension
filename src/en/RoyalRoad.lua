...
return {
	...
	searchFilters = {
		...
		FilterGroup("Status", {
			TriStateFilter(601, STATUS_FILTER_EXT[01]),
			TriStateFilter(602, STATUS_FILTER_EXT[02]),
			TriStateFilter(603, STATUS_FILTER_EXT[03]),
			TriStateFilter(604, STATUS_FILTER_EXT[04]),
			TriStateFilter(605, STATUS_FILTER_EXT[05]),
			TriStateFilter(606, STATUS_FILTER_EXT[06]),
		}),
