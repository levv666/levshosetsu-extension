-- {"id":1567186593,"ver":"1.0.5","libVer":"1.0.0","author":"","repo":"","dep":[]}
...
local function getPassage(chapterURL)
    ...
    local title = htmlElement:selectFirst("h1.text-3xl"):text()
    htmlElement = htmlElement:selectFirst("main .container > .border")
...
local function parseNovel(novelURL)
    ...
    local descriptionElement = document:selectFirst("div.prose")
    local genrelist = document:selectFirst("div.mb-4.flex.flex-wrap.justify-center")
    ...
    return NovelInfo({
        ...
        genres = genrelist and map(genrelist:select("div.inline-flex.items-center.rounded-full.border"), function(v) return v:text() end) or nil,
